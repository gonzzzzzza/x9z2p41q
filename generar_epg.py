...
# Lista completa de todos tus canales (Ahora todos a 3 horas)
todos_los_canales = [
    ...
    {"id": "TRACE.UK", "n": "TRACE UK", "t": "TRACE UK", "g": "Música", "i": "https://cdn.broadbandtvnews.com/wp-content/uploads/2024/07/02103920/Trace-UK.jpg", "d": "TRACE UK brings viewers the very best of national and international artists, playing the hottest hip-hop, grime, afrobeats and rap."},
    ...
    {"id": "Tigo.Sports.2.PY", "n": "Tigo Sports 2", "t": "Tigo Sports 2", "g": "Deportes", "i": "", "d": "Viví la emoción del deporte como si estuvieras en la cancha. Toda la pasión de los hinchas."},
    ...
    {"id": "ENT.Family", "n": "#ENTFamily", "t": "#ENTFamily", "g": "Películas", "i": "", "d": "Contenido familiar para toda la familia. Diversión y entretenimiento seguro las 24 horas."},
    {"id": "ENT.Channel", "n": "#ENTChannel", "t": "#ENTChannel", "g": "Películas", "i": "", "d": "El equilibrio perfecto de las películas y las series que marcaron generaciones."},
    {"id": "Totalmusic", "n": "#Totalmusic", "t": "#Totalmusic", "g": "Música", "i": "", "d": "La más amplia selección de videoclips de todos los géneros y épocas."},
    {"id": "Totalmusic.80", "n": "#Totalmusic80s", "t": "#Totalmusic80s", "g": "Música", "i": "", "d": "La más variada selección de videoclips de la década dorada de la música."},
    {"id": "Totalmusic.2000", "n": "#Totalmusic2000s", "t": "#Totalmusic2000s", "g": "Música", "i": "", "d": "Una cuidada selección de videoclips que marcaron los años 2000."},
    {"id": "Totalmusic.Concerts", "n": "#TotalmusicConcerts", "t": "#TotalmusicConcerts", "g": "Música", "i": "", "d": "Selección de conciertos en vivo inolvidables de actuaciones legendarias."},
    {"id": "Totalmusic.Dance", "n": "#TotalmusicDance", "t": "#TotalmusicDance", "g": "Música", "i": "", "d": "Selección vibrante de videoclips de música electrónica y dance."},
    ...
    {"id": "El.Mueble", "n": "El Mueble", "t": "El Mueble", "g": "Interés general", "i": "", "d": "Inspiración, diseño y decoración. Ideas y tendencias para transformar tu hogar."},
    ...
    {"id": "FMH.Kizzi", "n": "FMH Kizzi", "t": "FMH Kizzi", "g": "Música", "i": "", "d": "Todos se reúnen para disfrutar de lo mejor de la música de las mejores décadas, Kizzi te lo lleva a tu casa, sin cortes ni interrupciones. FHM con su canal Kizzi te invita a vivir esta aventura donde padres e hijos pueden disfrutar de los mejores vídeos musicales de los 70,80 y 90s, en la comodidad de tu casa."},
    ...
    {"id": "Santa.Maria", "n": "Santa María", "t": "Santa María", "g": "Religión", "i": "", "d": "Contenido religioso y formación espiritual con reflexiones para el hogar."},
    ...
    {"id": "Latam.Rural", "n": "Latam Rural", "t": "Latam Rural", "g": "Agro", "i": "", "d": "Todo el mundo agro en un solo lugar. Noticias, producción y tecnología."},
    ...
    {"id": "Noticias.Caracol", "n": "Noticias Caracol", "t": "Noticias Caracol", "g": "Noticias", "i": "", "d": "La información que necesitás con análisis y reportajes importantes."},
    {"id": "Radio.Cosquin.Rock", "n": "Radio Cosquín Rock", "t": "Cosquín Rock", "g": "Radios", "i": "", "d": "El rock argentino suena fuerte. Conciertos y clásicos."},
    {"id": "Radio.Del.Plata", "n": "Radio Del Plata", "t": "Radio Del Plata", "g": "Radios", "i": "", "d": "Variedad musical, noticias y entretenimiento."},
    {"id": "Radio.Disney", "n": "Radio Disney", "t": "Radio Disney", "g": "Radios", "i": "", "d": "Los hits que todos aman y contenido para chicos y adolescentes."},
...
def generar():
    ...
    ids_vistos = set()
    for lista in [canales_gh, todos_los_canales]:
        for c in lista:
    ...
    # Programación resto de canales (Todos a 3hs)
    for c in todos_los_canales:
        for d in range(2):
            for h in range(0, 24, 3):
                s = (inicio + timedelta(days=d, hours=h)).strftime("%Y%m%d%H%M%S +0000")
                e = (inicio + timedelta(days=d, hours=h+3)).strftime("%Y%m%d%H%M%S +0000")
                xml += f'  <programme start="{s}" stop="{e}" channel="{c["id"]}">\n'
                xml += f'    <title lang="es">{c["t"]}</title>\n<desc lang="es">{c["d"]}</desc>\n'
                xml += f'    <category>{c["g"]}</category>\n'
                if c.get("i"): xml += f'    <icon src="{c["i"]}" />\n'
                xml += f'  </programme>\n'
